  ...
  methods: {
    submitForm (formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          this.$message.success('提交成功'){{#if_eq lintConfig "airbnb"}};{{/if_eq}}
        } else {
          this.$message.error('提交失败'){{#if_eq lintConfig "airbnb"}};{{/if_eq}}
          return false{{#if_eq lintConfig "airbnb"}};{{/if_eq}}
        }
      })
    },
    resetForm (formName) {
      this.$refs[formName].resetFields(){{#if_eq lintConfig "airbnb"}};{{/if_eq}}
    }
  }
}
</script>
